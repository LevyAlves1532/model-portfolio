<template>
    <section class="mt-20 lg:mt-0 w-full relative text-white flex justify-center">
        ...
        <ul ref="stateSection" class="relative z-1 p-6 mx-auto w-11/12 lg:mx-0 rounded-3xl border dark:bg-[#ffffff29] bg-primary shadow-lg md:divide-x grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 lg:gap-12 border-secondary divide-secondary">
        ...
        const observer = new IntersectionObserver(
            ([entry]) => {
                if (entry.isIntersecting) {
                    ...
                    observer.disconnect(); // stop observing once it has
                }
            },
